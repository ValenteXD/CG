...
class SquareWithTextureApp(GLAPP):
    ...
    def drawDado(self):
        ...
        model = glm.rotate(a,glm.vec3(0,1,0))*glm.rotate(math.pi/4,glm.vec3(1,0,1))#glm.rotate(a,glm.vec3(1,0,0))*glm.rotate(a,glm.vec3(0,0,1))*glm.rotate(a,glm.vec3(0,1,0))
